        ...
        <div class="w-full max-w-md">
            <div class="ui-card overflow-hidden">
                <div class="border-b border-slate-200/70 bg-gradient-to-br from-white to-slate-50 px-6 py-5 dark:border-slate-800/70 dark:from-slate-950 dark:to-slate-900/40">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="ui-muted">Reset your admin password</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ui-card-body space-y-4">
                    @if (session('status'))
                        <div class="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800 dark:border-emerald-900/40 dark:bg-emerald-900/30 dark:text-emerald-100">
                    ...
                    <form method="POST" action="{{ route('admin.password.email') }}" class="space-y-4">
                        ...
                        <button type="submit" class="ui-btn ui-btn-primary w-full">Send reset link</button>
                    </form>
